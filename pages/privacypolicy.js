    ...
    <>
      <section className='bg-white'>
        <div className='border-8 border-gray-900 max-w-screen-xl px-4 py-12 mx-auto md:py-16 sm:px-6 lg:px-8 text-justify'>
          ...
          <br />
          <p>
            Welcome to <b> Energy Solution Engineering Ltd.</b>.
          </p>
          <br />
          <p>
            <b>Energy Solution Engineering Ltd.</b> (“us”, “we”, or “our”)
            operates <b>energysolutionbd.net</b> (hereinafter referred to as{" "}
            <b>“Service”</b>).
          </p>
          <br />
          <p>
            Our Privacy Policy governs your visit to <b>energysolutionbd.net</b>
          ...
          <br />
          <p>
            <b>SERVICE</b> means the energysolutionbd.net website operated by
            Energy Solution Engineering Ltd..
          </p>
          <br />
          <p>
          ...
          <p>
            Energy Solution Engineering Ltd. uses the collected data for various
            purposes:
          </p>
          ...
          <p>
            If you are located outside Dhaka, Bangladesh and choose to provide
            information to us, please note that we transfer the data, including
            Personal Data, to Dhaka, Bangladesh and process it there.
          </p>
          <p>
          ...
          <p>
            ...
            us at <b>info@energysolutionbd.net</b>.
          </p>
          ...
          <p>
            ...
            us by email: <b>info@energysolutionbd.net</b>.
          </p>
          <p className='mt-16 text-xs'>
            This{" "}
            <a href='https://policymaker.io/privacy-policy/'>Privacy Policy</a>{" "}
            was created for <b>energysolutionbd.net</b> by{" "}
            <a href='https://policymaker.io'>PolicyMaker.io</a> on 2022-09-01.
          </p>
        </div>
      </section>
    </>
